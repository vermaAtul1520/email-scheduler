...
// const popup = () => {
//   const { closePopup, popupData } = usePopupContext();
...
//         {true ? "Edit Schedule" : "Add Schedule"}
//       </span>
//       <div>
...
//             <button onClick={() => closePopup()} className={styles.cancleBtn}>
//               Cancel
//             </button>
//             <button
//               onClick={() => {
...
//       </div>
//       {/* <div className={styles.btnContainer}>
//         <button onClick={() => closePopup()} className={styles.cancleBtn}>Cancel</button>
//         <button onClick={() => {
//           // make api call to update.....
//           // handleFormSubmit();
//           closePopup();
